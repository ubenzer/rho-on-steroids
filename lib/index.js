...
function enhance(options) {
  ...
  var InlineCompiler = function(options) { rho.InlineCompiler.call(this, options); };
  var inlineCompilerPrototype = _.extendDeep({}, rho.InlineCompiler.prototype);
  InlineCompiler.prototype = inlineCompilerPrototype;

  var BlockCompiler = function(options) { rho.BlockCompiler.call(this, options); };
  var blockCompilerPrototype = _.extendDeep({}, rho.BlockCompiler.prototype);
